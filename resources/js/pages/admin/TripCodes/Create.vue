...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/admin/trip-codes/create' },
];
...
const form = useForm({
    ...
    direction: 'SB' as string,
    is_active: true,
});

function submit() {
    form.post('/admin/trip-codes', {
        preserveScroll: true,
    });
}
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            <div class="mx-auto w-full max-w-2xl">
                <Card>
                    <CardHeader>
                        <CardTitle>Create Trip Code</CardTitle>
                        <CardDescription>Define a new trip code for bus dispatch.</CardDescription>
                    </CardHeader>
                    <CardContent>
